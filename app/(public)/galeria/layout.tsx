...
export const metadata: Metadata = {
  title: "Galería",
  description: "Descubre la magia de los eventos realizados en Ruka Lefún. Galería de fotos de bodas, eventos corporativos, cumpleaños y celebraciones en medio de la naturaleza del sur de Chile.",
  keywords: [
    "galería eventos villarrica",
    "fotos bodas villarrica",
    "eventos realizados",
    "galería matrimonios",
