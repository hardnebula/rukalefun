...
import { ChevronLeft, ChevronRight, MapPin, Users, Maximize2, Calendar, Armchair, TreePine } from "lucide-react"
                      ...
                      <motion.img
                        ...
                        src={
                          currentSpace?.name?.toLowerCase().includes("principal")
                            ? "/Salon Principal/SalonPrincipal.webp"
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center group">
                <div className="bg-nature-forest/10 w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-nature-forest/20 transition-colors">
                  <Armchair className="h-10 w-10 text-nature-forest" />
                </div>
              ...
              <div className="text-center group">
                <div className="bg-nature-forest/10 w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-nature-forest/20 transition-colors">
                  <TreePine className="h-10 w-10 text-nature-forest" />
                </div>
